    ...
    <b-form v-if="show" style="margin-top:5%">
        <b-row cols="2">
            ...
            <b-col style="margin-top: 5%;">
                <b-button type="button" @click="onSubmit" variant="primary">Reportar</b-button>
            </b-col>
        </b-row>
    </b-form>
  </b-container>
  ...
  export default {
    data() {
      return {
        ...
        sintomas: [{ text: 'Seleccion sintoma', value: null }, 'Perdida del gusto', 'Gripa', 'Perdida del olfato'],
        show: true
      }
    },
    methods: {
      ...
      let body = this.form
      console.log(body);
      axios.post('https://dothggtj5k.execute-api.us-east-2.amazonaws.com/default/UdistritalLambdaAlertCovidUser', JSON.stringify(body) )
