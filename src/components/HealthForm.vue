  ...
  <div class="form">
    <div class="cardForm" style="display: flex; justify-content: center">
      <b-card
        ...
        class="mb-2"
      >
        <b-card-text> Por favor registrata tus datos de salud </b-card-text>
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://1zpgwgkp6l.execute-api.us-east-2.amazonaws.com/default/getTipeVaccine"
      )
      .then((response) => {
  ...
  methods: {
    onSubmit() {
      ...
      axios
        .post(
          "https://lb8lvzdr02.execute-api.us-east-2.amazonaws.com/default/UdistritalRegisterHealth",
          JSON.stringify(body)
        )
        .then((response) =>
          response.data == "ok"
