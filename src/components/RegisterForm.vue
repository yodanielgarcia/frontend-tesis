...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://mlszgwx586.execute-api.us-east-2.amazonaws.com/default/getCarrers"
      )
      .then((response) => {
    ...
    axios
      .get(
        "https://fjjt1ys7vi.execute-api.us-east-2.amazonaws.com/default/getTipeUser"
      )
      .then((response) => {
  ...
  methods: {
    onSubmit() {
      ...
      axios
        .post(
          "https://jgcu9imo1a.execute-api.us-east-2.amazonaws.com/default/UdistritalRegisterUser",
          JSON.stringify(body)
        )
        .then((response) =>
          response.data
            ? this.$router.push("/Socioeconomic/" + response.data)
    ...
    verifyEmal() {
      ...
      axios
        .post(
          "https://qhxynhmdif.execute-api.us-east-2.amazonaws.com/default/validateEmail",
          JSON.stringify(body)
        )
        .then((response) => {
